...
((Drupal) => {
  const { isDesktopNav } = Drupal.egsolive;
  ...
  Drupal.egsolive.toggleSubNav = toggleSubNav;
  ...
  function handleBlur(e) {
    if (!Drupal.egsolive.isDesktopNav()) return;
  ...
  Drupal.egsolive.closeAllSubNav = closeAllSubNav;
  ...
  Drupal.egsolive.areAnySubNavsOpen = areAnySubNavsOpen;
