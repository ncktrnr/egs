...
(function (Drupal) {
  ...
  function setStickyHeaderStorage(expandedState) {
    ...
    localStorage.setItem('Drupal.egsolive.stickyHeaderState', JSON.stringify(item));
  }
  ...
  function getStickyHeaderStorage() {
    var stickyHeaderState = localStorage.getItem('Drupal.egsolive.stickyHeaderState');
