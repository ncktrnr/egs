...
((Drupal) => {
  ...
  Drupal.egsolive.isDesktopNav = isDesktopNav;
  ...
  function setStickyHeaderStorage(expandedState) {
    ...
    localStorage.setItem(
      'Drupal.egsolive.stickyHeaderState',
      JSON.stringify(item),
    );
  }
  ...
  function getStickyHeaderStorage() {
    ...
    if (now.getTime() > item.expiry) {
      ...
      localStorage.removeItem('Drupal.egsolive.stickyHeaderState');
      return false;
    }
    return item.value;
  }
